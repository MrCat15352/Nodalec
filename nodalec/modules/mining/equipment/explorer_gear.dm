/obj/item/clothing/suit/hooded/explorer/survivor
	...
	lefthand_file = 'nodalec/icons/mob/inhands/clothing/lefthand.dmi'
	righthand_file = 'nodalec/icons/mob/inhands/clothing/righthand.dmi'
	icon = 'nodalec/icons/obj/clothing/suits.dmi'
	worn_icon = 'nodalec/icons/mob/clothing/suits.dmi'
	icon_state = "survivor"
...
/obj/item/clothing/head/hooded/explorer/survivor
	...
	icon = 'nodalec/icons/obj/clothing/hats.dmi'
	worn_icon = 'nodalec/icons/mob/clothing/head.dmi'
	icon_state = "survivor"
