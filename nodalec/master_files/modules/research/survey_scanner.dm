...
/obj/machinery/survey_scanner
	...
	icon = 'nodalec/master_files/modules/research/icons/objects.dmi'
...
/obj/machinery/survey_scanner/RefreshParts()
	...
	for(var/obj/item/stock_parts/servo/servos in component_parts)
		research_gain = ((servos.rating * 100) / 2) //50, 100, 150, 200
