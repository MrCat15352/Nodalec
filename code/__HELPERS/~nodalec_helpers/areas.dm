...
// 																/area/ship/science/ai_chamber))	// ANC - дубликат
...
// /proc/detect_room(turf/origin, list/break_if_found, max_size=INFINITY)	// ANC - дубликат
...
// /proc/create_area(mob/creator)	// ANC - дубликат
