...
// /proc/Gcd(a, b)
// 	return b ? Gcd(b, (a) % (b)) : a	//ANC - дубликат
...
// /proc/SolveQuadratic(a, b, c)	//ANC - дубликат
// 	ASSERT(a)
// 	. = list()
// 	var/d		= b*b - 4 * a * c
// 	var/bottom  = 2 * a
...
// /proc/closer_angle_difference(a, b)	//ANC - дубликат
// 	if(!isnum(a) || !isnum(b))
// 		return
...
// /proc/gaussian(mean, stddev)	//ANC - дубликат
...
// /proc/get_turf_in_angle(angle, turf/starting, increments)	//ANC - дубликат
// 	var/pixel_x = 0
// 	var/pixel_y = 0
...
// /proc/get_overlap(x1, y1, x2, y2, x3, y3, x4, y4)	//ANC - дубликат
...
// /proc/get_angle_raw(start_x, start_y, start_pixel_x, start_pixel_y, end_x, end_y, end_pixel_x, end_pixel_y)	// ANC дубликат
