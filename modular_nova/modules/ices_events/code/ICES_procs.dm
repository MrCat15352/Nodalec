...
/datum/controller/subsystem/events/proc/debug_event_schedule()
	...
	// message_admins("ICES: Transfer target: [SSautotransfer.targettime]")// NODALEC_SET_TURN_OFF
	message_admins("ICES: World time: [world.time]")
	message_admins("ICES: Start time: [SSticker.round_start_time]")
	// message_admins("ICES: Timer differential: [(SSautotransfer.targettime - world.realtime)]")	// NODALEC_SET_TURN_OFF
	...
	// else
	// 	message_admins("ICES: Timer precondition check: PASSED")	// NODALEC_SET_TURN_OFF
